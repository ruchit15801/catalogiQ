        ...
        <div className="max-w-5xl mx-auto relative z-10">
            <motion.div initial="hidden" animate="visible" variants={fadeUpVariant}>
              <span className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-[#e2e8f0] shadow-sm text-[#5B21B6] font-semibold text-xs md:text-sm rounded-full mb-6 md:mb-8">
                ...
                CatalogIQ Version 2.0 — Sharp.js Engine Live
              </span>
              ...
              <p className="t-hero-sub text-base sm:text-lg md:text-xl px-4">Marketplace algorithms penalize you for high-quality photos. Upload your product image below — our Sharp.js engine generates 64 variants instantly, finds the one that drops your volumetric weight to the lowest slab.</p>
            </motion.div>
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUpVariant} className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6 md:space-y-8">
                <div className="bg-[#f8fafc] p-6 md:p-8 rounded-2xl border border-[#e2e8f0] hover:border-[#7C3AED] transition-colors">
                    ...
                    <p className="text-[#475569] text-base md:text-lg leading-relaxed ml-9">Yes! We do not manipulate the physical product. We simply optimize the padding, background coverage, and file EXIF data to comply strictly with marketplace guidelines while avoiding artificial algorithmic penalties.</p>
                </div>
                <div className="bg-[#f8fafc] p-6 md:p-8 rounded-2xl border border-[#e2e8f0] hover:border-[#7C3AED] transition-colors">
